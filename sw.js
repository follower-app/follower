...
const CACHE_VERSION = 'follower-v56';  // DA-85 S1+: title card en 2 etapas (carga sin corazon -> corazon latiendo + tap) + bugfix isFirst contaminado por orden de persistencia del wizard
